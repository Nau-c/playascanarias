...
export const beaches: Beach[] = [
  ...
  },
  {
    ...
    latitude: 27.7972,
    longitude: -18.1486,
    description: "Arena roja volcánica. Salvaje y espectacular. Oleaje fuerte.",
    blueFlag: false,
    accessible: false,
    imageUrl:
      "https://www.holaislascanarias.com/sites/default/files/styles/masonry_image/public/resources/resource_image/el_hierro_verodal.jpg",
    weather: {
      temperature: 22,
      windSpeed: 20,
      waveHeight: 1.8,
  ...
  },
  {
    ...
    latitude: 27.8119,
    longitude: -17.9189,
    description: "Piscina natural entre lava. Muy popular y fotogénica.",
    blueFlag: false,
    accessible: true,
    imageUrl:
      "https://www.holaislascanarias.com/sites/default/files/styles/masonry_image/public/resources/resource_image/el_hierro_charco_azul.jpg",
    weather: {
      temperature: 23,
      windSpeed: 15,
      waveHeight: 0.5,
  ...
  },
  {
    ...
    latitude: 27.7972,
    longitude: -18.0319,
    description: "Conjunto de charcos naturales con accesos y solarium.",
    blueFlag: false,
    accessible: true,
    imageUrl:
      "https://www.holaislascanarias.com/sites/default/files/styles/masonry_image/public/resources/resource_image/el_hierro_maceta.jpg",
    weather: {
      temperature: 22,
      windSpeed: 12,
      waveHeight: 0.4,
  ...
  },
  {
    ...
    latitude: 27.7889,
    longitude: -18.0147,
    description: "Otra piscina natural preciosa, menos concurrida.",
    blueFlag: false,
    accessible: false,
    imageUrl:
      "https://www.holaislascanarias.com/sites/default/files/styles/masonry_image/public/resources/resource_image/el_hierro_charco_manso.jpg",
    weather: {
      temperature: 23,
      windSpeed: 10,
      waveHeight: 0.3,
  ...
  },
  {
    ...
    latitude: 27.7861,
    longitude: -17.9242,
    description: "Arena gris, muy tranquila, ideal para desconectar.",
    blueFlag: false,
    accessible: true,
    imageUrl:
      "https://www.holaislascanarias.com/sites/default/files/styles/masonry_image/public/resources/resource_image/el_hierro_timijiraque.jpg",
    weather: {
      temperature: 22,
      windSpeed: 14,
      waveHeight: 0.6,
  ...
  },
  {
    ...
    longitude: -13.5283,
    description:
      "La más famosa. Arena dorada, vistas al islote Montaña Clara. ¡Puro paraíso!",
    blueFlag: false,
    accessible: false,
    imageUrl:
      "https://www.holaislascanarias.com/sites/default/files/styles/masonry_image/public/resources/resource_image/playa_las_conchas_la_graciosa.jpg",
    weather: {
      temperature: 22,
      windSpeed: 18,
      waveHeight: 1.2,
  ...
  {
    id: 40,
    name: "Playa de La Francesa",
    island: "La Graciosa",
    latitude: 29.2317,
    longitude: -13.5036,
    description: "Ideal para nadar y hacer snorkel. Cerca del puerto.",
    blueFlag: false,
    accessible: true,
    imageUrl:
      "https://www.holaislascanarias.com/sites/default/files/styles/masonry_image/public/resources/resource_image/playa_francesa_la_graciosa.jpg",
    weather: {
      temperature: 23,
      windSpeed: 15,
      waveHeight: 0.5,
  ...
  {
    id: 41,
    name: "Playa de La Cocina",
    island: "La Graciosa",
    latitude: 29.2319,
    longitude: -13.5167,
    description: "Pequeña cala al pie de Montaña Amarilla. Aguas turquesas.",
    blueFlag: false,
    accessible: false,
    imageUrl:
      "https://www.holaislascanarias.com/sites/default/files/styles/masonry_image/public/resources/resource_image/playa_cocina_la_graciosa.jpg",
    weather: {
      temperature: 23,
      windSpeed: 12,
      waveHeight: 0.4,
  ...
  {
    id: 42,
    name: "Playa del Salado",
    island: "La Graciosa",
    latitude: 29.2458,
    longitude: -13.5042,
    description: "Muy tranquila, ideal para acampar (zona permitida).",
    blueFlag: false,
    accessible: true,
    imageUrl:
      "https://www.holaislascanarias.com/sites/default/files/styles/masonry_image/public/resources/resource_image/playa_salado_la_graciosa.jpg",
    weather: {
      temperature: 22,
      windSpeed: 14,
      waveHeight: 0.6,
  ...
  {
    id: 43,
    name: "Playa del Ámbar",
    island: "La Graciosa",
    latitude: 29.2694,
    longitude: -13.5083,
    description: "Al norte de la isla, poco accesible, pero preciosa.",
    blueFlag: false,
    accessible: false,
    imageUrl:
      "https://www.holaislascanarias.com/sites/default/files/styles/masonry_image/public/resources/resource_image/playa_ambar_la_graciosa.jpg",
    weather: {
      temperature: 22,
      windSpeed: 16,
      waveHeight: 0.8,
