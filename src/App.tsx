...
function App() {
  ...
  return (
    <>
      <Helmet>
        <title>Playas Canarias</title>
        <meta name="description" content="Descubre las mejores playas de las Islas Canarias con información actualizada sobre el clima y las condiciones del mar." />
        <meta name="keywords" content="playas, canarias, clima, mar, turismo" />
      </Helmet>
